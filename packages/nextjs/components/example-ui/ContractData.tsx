...
// TODO
// Here we could for example make a list of all the active tournaments and their participants.
...
export const ContractData = () => {
  ...
  const { data: totalCounter } = useScaffoldContractRead({
    ...
    args: ["0x4DAFE12E1293D889221B1980672FE260Ac9dDd28"],
  });
...
//   
  ...
  console.log("CompoundProtocol: ", CompoundProtocol?.address);

  const { showAnimation } = useAnimationConfig(totalCounter);

  const { data: currentGreeting, isLoading: isGreetingLoading } = useScaffoldContractRead({
    contractName: "CompoundProtocol",
    functionName: "tournamentCalculatedReward",
    args: ["0xF09F0369aB0a875254fB565E52226c88f10Bc839", "0xb2aD95B7dfe9fdeC2cA021b4cffE51566eEB6506"],
  });
        ...
        <div className="mt-3 border border-primary bg-neutral rounded-3xl text-secondary  overflow-hidden text-[116px] whitespace-nowrap w-full uppercase tracking-tighter font-bai-jamjuree leading-tight">
          <div className="relative overflow-x-hidden" ref={containerRef}>
            ...
            <div className="absolute -left-[9999rem]" ref={greetingRef}>
              <div className="px-4">{currentGreeting?.toString()}</div>
            </div>
